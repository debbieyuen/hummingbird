...
struct ScheduleWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = ScheduleWidgetAttributes(name: "Me")
    static let contentState = ScheduleWidgetAttributes.ContentState(value: 3)
